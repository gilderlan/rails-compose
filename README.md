...
7. Install the gems generated by Rails:

   ```bash
   docker compose run app bundle install
   ```

8. Run `docker compose run app rake db:create` to create the database.

9. To start the Rails server, run `docker compose up`.

10. Access `http://localhost:3000` in your browser to see the Rails home page.
